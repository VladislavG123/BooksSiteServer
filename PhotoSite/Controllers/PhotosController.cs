...
namespace PhotoSite.Controllers
{
    public class PhotosController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetPhoto(string id)
        {
        ...
        public async Task<IHttpActionResult> PutPhoto(string id, Photo photo)
        {
        ...
        // DELETE: api/Photos/5
        [ResponseType(typeof(Photo))]
        public async Task<IHttpActionResult> DeletePhoto(string id)
        {
            Photo photo = await db.Photos.FindAsync(id);
            if (photo == null)
            {
